...
file_to_load= os.path.join("Module3","Election_Analysis","Resources","election_results.csv")
...
with open(file_to_save, "w") as txt_file:
    #cool trick to format
    space= str("-"*3*len("Election Results")) 
    ...
    largest_county_results = (f"\n{space}\n{largest_county} had the largest turnout on the election\n{space}\n")    
    ...
    for candidate_name in candidate_votes:
        ...
        # Print each candidate's voter count and percentgit age to the
        # terminal.
